...
class LotteryResultsScreen extends StatefulWidget {
  const LotteryResultsScreen({super.key, required this.drawId});
              ...
              if (state is GetDrawResultsSuccessState) {
                if (state.response.data.draws.result == null) {
                  return AppPromptWidget(
                    title: 'No Result yet',
                    message:
                        'You will be updated once there is a result for this draw',
                    onTap: () {
                      _bloc.add(GetDrawResultEvent(widget.drawId));
                    },
                  );
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TabBarView(
                          children: [
                            LotteryDrawResults(
                                results: state.response.data.draws.result
                                            ?.results !=
                                        null
